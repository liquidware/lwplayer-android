...
public abstract class AACPlayer {
     ...
     */
    public void playAsync(final InputStream in) {
        new Thread(new Runnable() {
            public void run() {
                try {
                	Log.d(LOG, "playAsync Count=" + in.available());
                	Log.d(LOG, "Count=" + in.available());
                    play( in, -1 );
                }
                catch (Exception e) {
    ...
    public void play( String url, int expectedKBitSecRate ) throws Exception {
		...
		//mediaThread.addProgressListener(new MediaStatus() {
			...
			//public void onProgressUpdate(Integer... progress) {
				...
				AACPlayerActivity.tv.setText("Status:" + progress[0] + "," +
						"S:" + progress[1] + " KB/Sec," + 
						"D:" + progress[2] + " KB/Sec," +
						"A:" + progress[3] + " KB/Sec,");
						*/
			...
			//}
		//});
		//mediaThread.play(url);
		//play( mediaThread.getAsfInputStream(), expectedKBitSecRate);
