...
LOCAL_SRC_FILES += audio-thread.c
LOCAL_MODULE    := audio-thread
...
LOCAL_LDLIBS += -L$(call host-path,$(LOCAL_PATH)) -lavutil -lavcodec -llog

#include $(BUILD_STATIC_LIBRARY)

#include $(CLEAR_VARS)
#LOCAL_MODULE := audio-thread
#LOCAL_STATIC_LIBRARIES := audio-thread2
